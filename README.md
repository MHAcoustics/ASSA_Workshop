...
1. Download [Docker Desktop](https://www.docker.com/products/docker-desktop/)
  ...
  a. Install using the default settings.
  b.	Open Docker Desktop (the application must be running for CHORAS to work).
  c.	When prompted to sign in/up, you can click **Continue without signing up** or **Skip**.
  d.	If Docker Desktop tells you that WSL needs updating, please click Restart.
...
3.	Once the process is done, navigate to [http://localhost:5173](http://localhost:5173)
  a.	Once you see this, CHORAS is running!
